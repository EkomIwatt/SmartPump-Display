# SmartPump Display — TODO (done)

Finished work moved **verbatim** out of [`TODO.md`](TODO.md) on 2026-09-22, as its legend always said
it should be (`[x]` done → out of the live board). Item numbers are unchanged, so a reference to
“TODO #n” lands either there, here, or in [`POST_V1.md`](POST_V1.md). Open items that sat inside these
sections were moved back to `TODO.md` (marked where they stood). History only — nothing here is work.
...
- [x] **14. Error `message` discarded (MED) — DONE. Parsing 2026-09-12 (`4970c4e`), mapping
  ...
  - **New #18 ask:** the API returns human message strings only, several with interpolated values
    ...
    `message`.
- _(open item moved back to `TODO.md` → “Open items carried from finished phases”)_
...
- [x] _(ticked 2026-09-22 on archiving: the gate passed and Phase 10 merged)_ **10g — Gate: run it on the tablet against production. SITTING 2 PASSED 2026-09-19**, after
...
## Now — unblocked, high value — _done items moved here from `TODO.md`_
...
## Waiting on external input — _done items moved here from `TODO.md`_
...
## Gated / later — _done items moved here from `TODO.md`_
...
- [x] _(ticked 2026-09-22 on archiving: merged as Phase 10)_ **8. Payment feature flows — UNBLOCKED 2026-09-17. Moved to its own section: see
